...
type Kline interface {
	...
	GetKlines1h(getKlinesQueryParams entity.GetKlinesQueryParams) ([]entity.Kline, error)
	GetKlines30m(getKlinesQueryParams entity.GetKlinesQueryParams) ([]entity.Kline, error)
